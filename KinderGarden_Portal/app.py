"""
Пред защита диплом (ВКР).
Тема: Создание интерактивного веб-сервиса для внутреннего обмена информацией и документами фирмы "Satti"
моды:Python, Flask, SQLite3, HTML/CSS.
"""
...
def init_db():
    ...
    Создает все необходимые таблицы, если они еще не существуют при первом запуске.
    """
...
# === ДИНАМИЧЕСКИЕ СТРАНИЦЫ (КНОПКИ НА ДЕРЕВЬЯХ) ===
@app.route('/page/<page_name>')
def show_page(page_name):
    # Словарь со всеми текстами для наших страниц
    pages_data = {
        'about': {
            'title': 'О нас', 
    ...
    # Ищем запрашиваемую страницу в нашем словаре
    ...
    # Отдаем красивый шаблон с нужным текстом
